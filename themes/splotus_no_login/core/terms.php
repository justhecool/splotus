<paper-dialog id="terms" with-backdrop class="paper-dialog" style="overflow:auto;">
    <h3 class="mdl-dialog__title">Terms & Rules</h3>
    <hr>
<p>The providers ("we", "us", "our") of the service provided by this web site ("Service") are not responsible for any user-generated content and accounts ("Content"). Content submitted express the views of their author only.
...
If you do not agree with these terms, please do not register or use this Service. If you wish to close your account, please contact us.</p>
</paper-dialog>