		...
		<div class="mdl-cell mdl-cell--12-col">
			<div class="content-card">
				<div class="icon-and-title-flex">
					<img src="<?=$imageUrl;?>/games/ib/" class="appicon"></img>
					<div class="title-container">
						<span class="text-title">Island Builder</span>
				...
				<span class="text-description" style="font-size: 1.1em">Create your own island with over 20 different types of blocks and decorations! Looking for inspiration? gain some through viewing other islands in the game!</span><? if (is_user_logged_in()){} else{?>
     ...
     data-ad-format="auto"></ins><?if ($visitor[ 'user_id']){?><a href="<?=$forumUrl?>account/upgrades" rel="noopener"><paper-button class="x">Remove Ads</paper-button></a><?}}?>
			...
			<div class="wow fadeInUp content-works" id="spoilers">
			    <div class="screenshot-item">
                    <a href="<?=$imageUrl;?>/games/ib-1/">
                        <img src="<?=$imageUrl;?>/games/ib-1/">
                    </a>
                </div>
                <div class="screenshot-item">
                    <a href="<?=$imageUrl;?>/games/ib-2/">
                        <img src="<?=$imageUrl;?>/games/ib-2/">
                    </a>
                </div>
                <div class="screenshot-item">
                    <a href="<?=$imageUrl;?>/games/ib-3/">
                        <img src="<?=$imageUrl;?>/games/ib-3/">
                    </a>
                </div>
                <div class="screenshot-item">
                    <a href="<?=$imageUrl;?>/games/ib-4/">
                        <img src="<?=$imageUrl;?>/games/ib-4/">
                    </a>
                </div>
     	    </div>
		...
		<div class="wow fadeInUp content-card" style="margin-top: 0;">
			...
			<div>
				<div class="detail-item">
					...
					<span class="text-description">Casual, Creativity</span>
				</div>
				<div class="detail-item">
					<span class="details-icon icon">star</span>
					<span class="text-description">Average Rating 2.9</span>
				</div>
				<div class="detail-item">
					<span class="details-icon icon">info</span>
					<span class="text-description">Version 1.1<span>
				</div>
				<div class="detail-item">
					<span class="details-icon icon">mail</span>
...
<a href="http://www.newgrounds.com/portal/view/668023" target="_blank" class="mdl-button mdl-js-button mdl-js-ripple-effect mdl-button--fab mdl-button--mini-fab"><i class="material-icons">computer</i></a></div>
<div class="mdl-speed-dial__option">
<p class="mdl-speed-dial__tooltip mdl-speed-dial__tooltip--hidden">Get on the Play-Store!</p>
<a href="https://play.google.com/store/apps/details?id=air.com.splotus.IslandBuilder" target="_blank" class="mdl-button mdl-js-button mdl-js-ripple-effect mdl-button--fab mdl-button--mini-fab"><i class="material-icons">android</i></a></div>
</div>
