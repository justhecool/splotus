		...
		<div class="mdl-cell mdl-cell--12-col">
			<div class="content-card">
				<div class="icon-and-title-flex">
					<img src="<?=$imageUrl;?>/games/i/" class="appicon"></img>
					<div class="title-container">
						<span class="text-title">Idle City</span>
				...
				<span class="text-description" style="font-size: 1.1em">Upgrade and watch over your own randomly generated city. Gain money while playing to upgrade and better your city. Increase your income, population, and rating!</span><? if (is_user_logged_in()){} else{?>
     ...
     data-ad-format="auto"></ins><?if ($visitor[ 'user_id']){?><a href="<?=$forumUrl?>account/upgrades" rel="noopener"><paper-button class="x">Remove Ads</paper-button></a><?}}?>
			...
			<div class="wow fadeInUp content-works" id="spoilers">
			    <div class="screenshot-item">
                    <a href="<?=$imageUrl;?>/games/i-1/">
                        <img src="<?=$imageUrl;?>/games/i-1/">
                    </a>
                </div>
                <div class="screenshot-item">
                    <a href="<?=$imageUrl;?>/games/i-2/">
                        <img src="<?=$imageUrl;?>/games/i-2/">
                    </a>
                </div>
                <div class="screenshot-item">
                    <a href="<?=$imageUrl;?>/games/i-3/">
                        <img src="<?=$imageUrl;?>/games/i-3/">
                    </a>
                </div>
     	    </div>
		<div class="wow fadeInUp content-card" style="margin-top: 0;">
			...
			<div>
				...
				<div class="detail-item">
					...
					<span class="text-description">Average Rating 2.1</span>
				</div>
				<div class="detail-item">
					<span class="details-icon icon">info</span>
					<span class="text-description">Version 'Museum'<span>
				</div>
				<div class="detail-item">
					<span class="details-icon icon">mail</span>
				...
				<div class="detail-item">
					...
					<span class="text-description">5,000 - 10,000 downloads</span>
				</div>
				<div class="detail-item">
...
<a href="https://play.google.com/store/apps/details?id=air.IdleMobile" target="_blank" class="mdl-button mdl-js-button mdl-js-ripple-effect mdl-button--fab mdl-button--mini-fab"><i class="material-icons">android</i></a></div>
</div>
