		...
		<div class="mdl-cell mdl-cell--12-col">
			<div class="content-card">
				<div class="icon-and-title-flex">
					<img src="<?=$imageUrl;?>/games/jt/" class="appicon"></img>
					<div class="title-container">
						<span class="text-title">Jingle Tapper</span>
				...
				<span class="text-description" style="font-size: 1.1em">Santa has thrown you on the naughty list this year, turns out you've been extremely naughty! He requires you to ring a jolly bell and gain enough Karma to be put back on the nice list. Upgrade, unlock, and open presents to get back on the nice list in the least amount of time possible!</span><? if (is_user_logged_in()){} else{?>
     ...
     data-ad-format="auto"></ins><?if ($visitor[ 'user_id']){?><a href="<?=$forumUrl?>account/upgrades" rel="noopener"><paper-button class="x">Remove Ads</paper-button></a><?}}?>
			...
			<div class="wow fadeInUp content-works" id="spoilers">
			    <div class="screenshot-item">
                    <a href="<?=$imageUrl;?>/games/jt-1/">
                        <img src="<?=$imageUrl;?>/games/jt-1/">
                    </a>
                </div>
                <div class="screenshot-item">
                    <a href="<?=$imageUrl;?>/games/jt-2/">
                        <img src="<?=$imageUrl;?>/games/jt-2/">
                    </a>
                </div>
     	    </div>
		<div class="wow fadeInUp content-card" style="margin-top: 0;">
			...
			<div>
				...
				<div class="detail-item">
					...
					<span class="text-description">Average Rating 4.0</span>
				</div>
				<div class="detail-item">
					<span class="details-icon icon">info</span>
					<span class="text-description">Version 1.0.0<span>
				</div>
				<div class="detail-item">
					<span class="details-icon icon">mail</span>
...
<a href="http://www.newgrounds.com/portal/view/667292" target="_blank" class="mdl-button mdl-js-button mdl-js-ripple-effect mdl-button--fab mdl-button--mini-fab"><i class="material-icons">computer</i></a></div>
<div class="mdl-speed-dial__option">
<p class="mdl-speed-dial__tooltip mdl-speed-dial__tooltip--hidden">Get on the Play-Store!</p>
<a href="https://play.google.com/store/apps/details?id=air.com.spotus.jollybelltap" target="_blank" class="mdl-button mdl-js-button mdl-js-ripple-effect mdl-button--fab mdl-button--mini-fab"><i class="material-icons">android</i></a></div>
</div>
